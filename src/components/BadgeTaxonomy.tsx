...
import { Card, Select, Tag, Toast, ToastWrapper } from "@cedcommerce/ounce-ui";
import React, { useEffect, useState } from "react";
function BadgeTaxonomy() {
  ...
  return (
    <div className="hero">
      {selectedCategory.length > 0 &&
        selectedCategory.map((it: any, i: number) => (
          <Tag
            destroy={() => {
              deleteTag(i);
            }}
